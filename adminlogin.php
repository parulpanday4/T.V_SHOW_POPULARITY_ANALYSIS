...
<body>
   ...
   <header role="banner" id="fh5co-header">
	 ...
	 <form method="POST">
	   <h2>Sign In</h2>
	   <input type="text" id="username" placeholder="Enter Username" name="un" required>
	   <input type="password" id="password" placeholder="Enter Password" name="pass" required>
	   <input type="submit" id="login-btn"  name="but" value="SIGN IN"  >
...
if(isset($_POST['but']))
{
	...
	session_start();
	$query="select * from admins where name='$user' and password='$pass'";
